...
<<<<<<< HEAD
            ...
            const url = 'https://mmaproject-production.fly.dev/api/users/verify-token'; //CONEXION FIREBASE
=======
            const url = 'https://mmaproject-production.fly.dev/api/users/verify-token'; //FLY 
>>>>>>> develop
